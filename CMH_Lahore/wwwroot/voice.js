...
function uploadtophp() {
  {
    ...
    xhr.onload = function (e) {
      if (this.readyState === 4) {
        ...
        console.log("File Uploaded to Server Location Successfully");
        //wait(15000);
        window.location.href = "./submissionComplete.php";
      }
    };

    var fd = new FormData();

    fd.append("audio_data", glblob, filename);
    xhr.open("POST", "uploadvoice.php", true);
    xhr.send(fd);
  }
}
